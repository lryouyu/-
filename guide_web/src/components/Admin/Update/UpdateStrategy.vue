    ...
    <transition name="el-zoom-in-bottom">
        <div v-show="true" class="transition-box">
            <el-card class="box-card" >
                <el-form ref="ruleFormRef" :model="strategy" :rules="rules" style="height: 500px">
...
<script setup>
    ...
    import {getStrategyById,updateStrategy} from "@/api/strategy";
    ...
    const rules = reactive({
        ...
        content: [
            ...
            {min: 0, max: 100, message: '攻略内容最多不超过100字', trigger: "blur"}
        ],warn: [
